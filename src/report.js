...
function renderSummary(data, context = {}) {
  ...
  markdown += '---\n\n';
  markdown += `<sub>Generated by the **Test Automation Reporting action**. [**Tesults**](${TESULTS_URL}) adds cross-system consolidation, test history, regression and flaky analysis, AI failure intelligence, release tracking, and notifications.</sub>\n`;
