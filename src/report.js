...
function renderSummary(data, context = {}) {
  ...
  markdown += '---\n\n';
  markdown += `_Report generated by [Tesults](${TESULTS_URL}). For history across runs, automated regression detection, AI failure intelligence, and consolidated results across your test systems, explore Tesults._\n`;
