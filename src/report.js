...
function octicon(filename, alt, context = {}) {
  return `<img src="${octiconUrl(filename, context)}" width="14" height="14" align="middle" alt="${alt}" />`;
}
...
function renderSummary(data, context = {}) {
  ...
  markdown += '---\n\n';
  markdown += `<sub>Generated by [Tesults](${TESULTS_URL}) · History, regressions, flaky analysis, AI failure intelligence, and consolidated test results.</sub>\n`;
